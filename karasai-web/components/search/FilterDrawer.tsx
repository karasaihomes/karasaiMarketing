...
export default function FilterDrawer({ isOpen, onClose, filters, setFilters, clearFilters }: FilterDrawerProps) {
    ...
    <div className="fixed inset-0 z-[60] lg:hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 max-h-[85vh] overflow-y-auto rounded-t-2xl bg-white">
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-neutral-gray bg-white px-6 py-4">
          ...
          <button
            onClick={onClose}
            className="rounded-full p-1 text-neutral-dark/60 transition-colors hover:bg-neutral-gray hover:text-neutral-dark"
            aria-label="Close"
          >
            <X className="h-6 w-6" />
          </button>
        ...
        {/* Footer Buttons */}
        <div className="sticky bottom-0 border-t border-neutral-gray bg-white p-4">
          <div className="grid grid-cols-2 gap-3">
            <button
              onClick={handleClearAndClose}
              className="rounded-md border-2 border-karasai-blue bg-white px-4 py-3 text-sm font-semibold text-karasai-blue transition-colors hover:bg-karasai-light"
            >
              Clear All
            </button>
            <button
              onClick={onClose}
              className="rounded-md bg-karasai-blue px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-karasai-blue/90"
            >
              Show Results
            </button>
          </div>
